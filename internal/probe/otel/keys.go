...
func (p *rotationCheckProbe) End()                      { p.finish() }
...
func (p *diskRotateProbe) End()                      { p.finish() }
...
func (p *memoryRotateProbe) End()                      { p.finish() }
